...
export const translations = {
  hi: {
    ...
    phonePlaceholder: '10 अंकों का मोबाइल नंबर', validPhoneError: 'कृपया सही 10 अंकों का मोबाइल नंबर डालें।', profileOptionalHint: 'प्रोफ़ाइल अभी पूरी कर सकते हैं या बाद में सेटिंग में कर सकते हैं।', skipForNow: 'अभी छोड़ें', saveAndStart: 'सेव करके शुरू करें',
    ...
    voiceCall: 'वॉइस कॉल', incomingVoiceCall: 'इनकमिंग वॉइस कॉल', calling: 'कॉल लग रही है…', connecting: 'कनेक्ट हो रहा है…', mute: 'म्यूट', unmute: 'अनम्यूट', endCall: 'कॉल समाप्त',
  ...
  en: {
    ...
    phonePlaceholder: '10-digit mobile number', validPhoneError: 'Please enter a valid 10-digit mobile number.', profileOptionalHint: 'You can complete your profile now or do it later from Settings.', skipForNow: 'Skip for now', saveAndStart: 'Save & start',
    ...
    voiceCall: 'Voice call', incomingVoiceCall: 'Incoming voice call', calling: 'Calling…', connecting: 'Connecting…', mute: 'Mute', unmute: 'Unmute', endCall: 'End call',
