...
## 9. Status (टेक्स्ट/फ़ोटो/वीडियो, 24 घंटे)
- टेक्स्ट स्टेटस Realtime Database में रहता है; फ़ोटो/वीडियो Firebase Storage में (देखें #3b) — असली URL सिर्फ़ Database में सेव होता है।
- 24 घंटे बाद स्टेटस अपने-आप दिखना बंद हो जाता है (क्लाइंट साइड फ़िल्टर से)। असल डेटा हटाने के लिए कोई केंद्रीय cleanup job नहीं है (कोई Cloud Function नहीं) — जिस व्यक्ति का स्टेटस है, उसका अपना ऐप जब भी अगली बार खुलता है, वो अपने पुराने expired स्टेटस खुद मिटा देता है।
- Reactions (इमोजी) और comments किसी भी signed-in यूज़र को दिख सकते हैं, जैसे WhatsApp में स्टेटस दिखता है — "किसने देखा" वाली लिस्ट सिर्फ़ स्टेटस के मालिक और एडमिन को दिखती है।
- Rules और `lib/status.js` का `adminDeleteStatus()` एडमिन को किसी का भी status पूरी तरह मिटाने की क्षमता देते हैं (Database + Storage से) — पर Admin Dashboard में अभी इसके लिए कोई बटन नहीं जोड़ा गया है इस राउंड में; चाहें तो अगली बार जोड़ सकता हूं।
